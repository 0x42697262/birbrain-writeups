...
[NOTE]
====
The challenge can be downloaded here: xref:attachment$a-new-hire/forensics_a_new_hire.zip[forensics_a_new_hire.zip]
====
...
[NOTE]
====
Download the email: xref:attachment$a-new-hire/email.eml[email.eml]
====
...
image::a-new-hire/1_index.png["index.php"]
...
[NOTE]
====
Download the Windows shortcut file: xref:attachment$a-new-hire/Resume.pdf_.lnk[Resume.pdf .lnk]
====
...
. **Opens `resume_official.pdf`** – Likely a decoy document.
. **Executes `client.py`** – A Python script hosted on the remote server.
...
[NOTE]
====
Download the resume: xref:attachment$a-new-hire/resume_official.pdf[resume_official.pdf]
Download the python script: xref:attachment$a-new-hire/client.py[client.py]
====
