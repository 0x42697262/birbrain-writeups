...
[NOTE]
====
The challenge can be downloaded here: xref:attachment$thorins-amulet/forensics_thorins_amulet.zip[forensics_thorins-amulet.zip]
====
...
[NOTE]
====
The source code of the script can be downloaded xref:attachment$thorins-amulet/files/artifact.ps1[here].
====
...
[NOTE]
====
The source code of `update.ps1` can be downloaded xref:attachment$thorins-amulet/files/update.ps1[here].
====
...
[NOTE]
====
The source code of `a541a.ps1` can be downloaded xref:attachment$thorins-amulet/files/a541a.ps1[here].
====
