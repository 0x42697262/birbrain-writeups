...
_The challenge can be downloaded here: attachment::thorins-amulet/forensics_thorins_amulet.zip[forensics_thorins-amulet.zip]_
...
_The source code of the script can be downloaded attachment:thorins-amulet/files/artifact.ps1[here]._
...
_The source code of `update.ps1` can be downloaded attachment:thorins-amulet/files/update.ps1[here]._
...
_The source code of `a541a.ps1` can be downloaded attachment:thorins-amulet/files/a541a.ps1[here]._
